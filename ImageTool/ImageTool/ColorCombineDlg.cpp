...
IMPLEMENT_DYNAMIC(CColorCombineDlg, CDialog)

CColorCombineDlg::CColorCombineDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CColorCombineDlg::IDD, pParent)
  , m_strColorSpace(_T(""))
  , m_pDoc1(NULL)
  , m_pDoc2(NULL)
  , m_pDoc3(NULL)
...
BEGIN_MESSAGE_MAP(CColorCombineDlg, CDialog)
...
BOOL CColorCombineDlg::OnInitDialog()
{
  ...
  if (nIndex == 0)
  {
    AfxMessageBox(TEXT("no have Grayscale Image"));
